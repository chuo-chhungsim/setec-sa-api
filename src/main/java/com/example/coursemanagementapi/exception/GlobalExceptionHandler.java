...
public class GlobalExceptionHandler {
    ...
    // UsernameNotFoundException (from Spring Security)
    ...
    public ResponseEntity<Map<String, Object>> handleUsernameNotFound(
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(buildErrorBody(HttpStatus.UNAUTHORIZED, "UserNotFound",
                        ex.getMessage() != null ? ex.getMessage() : "User not found.", request));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(Exception ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(buildErrorBody(HttpStatus.INTERNAL_SERVER_ERROR, "InternalServerError",
